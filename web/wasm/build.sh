...
em++ -O2 $OBJECTS \
  -sALLOW_MEMORY_GROWTH=1 -sEXPORTED_FUNCTIONS='["_preview_init","_preview_set_profile","_preview_set_climate","_preview_clear_weather","_preview_set_weather_current","_preview_set_weather_day","_preview_render","_preview_frame","_preview_width","_preview_height"]' \
