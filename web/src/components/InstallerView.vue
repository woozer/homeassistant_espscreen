      ...
      <template v-else>
        <fieldset>
          ...
          <div class="boards">
            ...
            <label class="board"><input type="radio" name="virtual-profile" value="virtual720" v-model="form.board" @change="form.orientation = 'landscape'" /><span><b>Waveshare ESP32-P4-WIFI6-Touch-LCD-4B</b><small>720 × 720 · 2 × 3 · editor preview</small></span></label>
          </div>
        </fieldset>
        <div class="field">
